...
def summarize_performance(step, g_model, dataset, n_samples=3):
    ...
    for i in range(n_samples):
        ...
        pyplot.axis('off')
        pyplot.imshow(X_realA[i].reshape((256, 256)))
...
# %% load image data
src, tar = load_real_samples('data/data64_std.npz')
...
# g_model.save('model_256_x1000_1000.h5')
# %%
res = g_model.predict(src_valid)
# %%
# plt = pyplot
# plt.imshow((res[20].reshape((256, 256))), vmin=-4, vmax=3)
# plt.colorbar()
# plt.title('pred, 1000 epoch')
# plt.show()
# plt.imshow((tar_train[20].reshape((256, 256))), vmin=-4, vmax=3)
# plt.colorbar()
# plt.title('truth, 1000 epoch')
# plt.show()
# %%
