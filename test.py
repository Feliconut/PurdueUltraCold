...
from UltraCold import MTF, NPS, OD, plot_od_avg, Sk
...
OD.visualize(ODs_atom_avg)

OD.visualize(ODs_noise_avg)
# %%
...
# %% # Calibrate
M2k_Exp, _ = NPS.from_od(ODs_noise, ODs_noise_avg, imgSysData=imgSysData)
M2k_Fit, rms_min, popt, pcov, k_x, k_y, K_x, K_y, d = \
            MTF.fit(M2k_Exp, imgSysData)
...
from UltraCold.plotting import fplot_pupil, fplot_PSF, fplot_PSF_LineCut, fplot_PSF_abs2, fplot_PSF_abs2_LineCut, fplot_NPS_ExpAndFit
